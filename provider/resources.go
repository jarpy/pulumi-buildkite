...
import (
	...
	"github.com/jarpy/pulumi-buildkite/provider/pkg/version"
...
func Provider() tfbridge.ProviderInfo {
	...
	p := shimv2.NewProvider(buildkite.Provider())
	...
	prov := tfbridge.ProviderInfo{
		...
		Keywords:   []string{"pulumi", "buildkite", "category/cloud"},
		License:    "Apache-2.0",
		...
		DataSources: map[string]*tfbridge.DataSourceInfo{
			...
			"buildkite_meta":     {Tok: tfbridge.MakeDataSource(mainPkg, mainMod, "getMetadata")},
			"buildkite_pipeline": {Tok: tfbridge.MakeDataSource(mainPkg, mainMod, "getPipeline")},
		},
