...
namespace Pulumi.Buildkite
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Buildkite.version.txt");
    ...
    internal sealed class BuildkiteResourceTypeAttribute : Pulumi.ResourceTypeAttribute
    {
