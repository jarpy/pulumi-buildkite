...
namespace Pulumi.Buildkite
{
    ...
    /// ```
    /// </summary>
    [BuildkiteResourceType("buildkite:index/agentToken:AgentToken")]
    public partial class AgentToken : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public AgentToken(string name, AgentTokenArgs? args = null, CustomResourceOptions? options = null)
            : base("buildkite:index/agentToken:AgentToken", name, args ?? new AgentTokenArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AgentToken(string name, Input<string> id, AgentTokenState? state = null, CustomResourceOptions? options = null)
            : base("buildkite:index/agentToken:AgentToken", name, state, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class AgentTokenArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// This is the description of the agent token.
        /// </summary>
    ...
    public sealed class AgentTokenState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// This is the description of the agent token.
        /// </summary>
