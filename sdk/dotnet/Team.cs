...
namespace Pulumi.Buildkite
{
    ...
    /// ```
    /// </summary>
    [BuildkiteResourceType("buildkite:index/team:Team")]
    public partial class Team : Pulumi.CustomResource
    {
        ...
        public Team(string name, TeamArgs args, CustomResourceOptions? options = null)
            : base("buildkite:index/team:Team", name, args ?? new TeamArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Team(string name, Input<string> id, TeamState? state = null, CustomResourceOptions? options = null)
            : base("buildkite:index/team:Team", name, state, MakeResourceOptions(options, id))
        {
        }
